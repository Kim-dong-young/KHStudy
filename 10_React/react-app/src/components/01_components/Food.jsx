...
export default Food;
// export default : 하나의 파일에서 단일 항목만 기본으로 내보내고 싶을때
//                  -> 모듈에 특정 함수나 변수를 등록할 때 사용하는 명령어
//                  -> 모듈에 등록하면 import를 통해서 어디서든 가져와 사용가능