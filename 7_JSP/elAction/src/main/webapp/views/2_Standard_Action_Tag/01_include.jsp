...
<body>
	...
	<h4>1. 기존 include 지시어를 이용한 방식(정적 include방식 == 컴파일시 애초에 포함되어 있는 상태)</h4>
	
	<%--
	<%@ include file="footer.jsp" %>
	<br><br>
	
	특징 : include하고있는 페이지 상에 선언되어있는 변수를 현재 페이지에서도 사용가능<br>
	...
	특징 2. : 포함시, include된 페이지로 값을 전달할 수 있음<br>
	<jsp:include page="footer.jsp">
