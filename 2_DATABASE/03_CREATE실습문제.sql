...
--5개 정도의 샘플 데이터 추가하기
/*
    100, '자바정복기', '최지원', 1000000, 1
    101, '자바정복기2', '최지원', 1000000, 1
    102, '자바정복기3', '최지원', 2000000, 2
    103, '자바정복기4', '최지원', 3000000, 3
    104, '자바정복기5', '최지원', 3000000, 3
...
CREATE TABLE TB_MEMBER(
  ...
  -- 보통 실무에선 탈퇴여부를 날짜로 많이 저장한다. NULL => 회원, 탈퇴날짜 => 탈퇴한 회원
  ENROLL_DATE DATE DEFAULT SYSDATE CONSTRAINT MEMBER_NN_EN NOT NULL
);

--5개 정도의 샘플 데이터 추가하기
/*
    200, 'USER01','PASS01', '최지원', 'M', NULL, NULL, DEFAULT, DEFAULT
    201, 'USER02','PASS01', '최지투', 'M', NULL, NULL, DEFAULT, DEFAULT
    ...
    204, 'USER05','PASS01', '최지파이브', 'M', NULL, NULL, DEFAULT, DEFAULT
*/

INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(200, 'USER01', 'PASS01', '최지원', 'M');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(201, 'USER02', 'PASS02', '최지투', 'M');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(202, 'USER03', 'PASS03', '최지쓰리', 'M');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(203, 'USER04', 'PASS04', '최지포', 'M');
INSERT INTO TB_MEMBER(MEMBER_NO, MEMBER_ID, MEMBER_PWD, MEMBER_NAME, GENDER) VALUES(204, 'USER05', 'PASS05', '최지파이브', 'M');
